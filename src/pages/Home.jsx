...
export default function Home() {
  return (
    <div className="space-y-16 md:space-y-24 lg:space-y-28 pb-14 md:pb-20 lg:pb-24">
...
<br></br><br></br><br></br>
      {/* Testimonials */}
      {/* <section className="bg-white pt-10 pb-24  py-24 overflow-hidden">
          ...
          <div className="overflow-hidden">
            ...
            <div className="flex gap-8 animate-scroll">
              ...
              {[...testimonials, ...testimonials].map((t, i) => (
                ...
                {/*  CTA */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#1E3A5F] rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-12 md:p-20 text-center text-white">
          ...
          <Link
            to="/events"
            className="inline-flex px-8 sm:px-10 py-3 sm:py-4 bg-white text-[#1E3A5F] rounded-full font-bold hover:scale-105 transition shadow-xl"
          >
             View Events
          </Link>
        </div>
